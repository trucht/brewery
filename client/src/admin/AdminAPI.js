...
export const createCategory = async (userId, token, category) => {
  return fetch(`/categories/${userId}`, {
    method: "POST",
    headers: {
...
export const getStatusValues = (userId, token) => {
  return fetch(`/orders/status-values/${userId}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
...
export const updateOrderStatus = (userId, token, orderId, status) => {
  return fetch(`/orders/${orderId}/status/${userId}`, {
    method: "PUT",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
...
export const getProducts = () => {
  return fetch(`/products?limit=100`, {
    method: "GET",
  })
    .then((response) => {
      return response.json();
...
export const updateProduct = (productId, userId, token, productData) => {
  return fetch(`/products/${productId}/${userId}`, {
    method: "PUT",
    headers: {
      Accept: "application/json",
      Authorization: `Bearer ${token}`,
