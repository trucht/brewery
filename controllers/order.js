...
exports.create = async (req, res) => {
  ...
  let messageToUser = {
    ...
    text:
      "Hello " +
      req.profile.name +
      ", \n\nYou have successfully made purchase of " +
      req.body.order.amount +
      "on Beer Brewery. Please check your dashboard to track the status of your order.\n\nRegards, \nBeer Brewery",
  };
...
exports.statusValues = function (req, res) {
